...
function asthir_logo_text_item()
{
...
?>
				...
				<div class="container pb-5 pt-5">
					<div class="asthir-logotext text-<?php echo esc_attr($asthir_logo_position); ?>">
						...
						<?php if (display_header_text() == true || (display_header_text() == true && is_customize_preview())): ?>
							...
							?>
								<p class="site-description"><?php echo $asthir_description; // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped 
															?></p>
							<?php endif; ?>
						<?php endif; ?>
					</div>
	...
	add_action('asthir_logo_text', 'asthir_logo_text_item');


	function asthir_mobile_menu_output()
	{
		?>
					...
					<div class="mobile-menu-wrap">
						...
						<nav id="mobile-navigation" class="mobile-navigation">
							<button id="mmenu-btn" class="menu-btn" aria-expanded="false">
								<span class="mopen"><?php esc_html_e('Menu', 'asthir'); ?></span>
								<span class="mclose"><?php esc_html_e('Close', 'asthir'); ?></span>
							</button>
							<?php
							wp_nav_menu(array(
								'theme_location' => 'menu-1',
	...
	add_action('asthir_mobile_menu', 'asthir_mobile_menu_output');
